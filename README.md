...
- **Custom Token Formats:** Easily toggle between `#1-100`, `1-100`, or alphabetical `A-Z` tokens. The system intelligently loops and syncs across all screens.
...
- **Receptionist Dashboard:** [http://localhost:5173/receptionist](http://localhost:5173/receptionist)
- **Patient TV Display:** [http://localhost:5173/patient](http://localhost:5173/patient)
